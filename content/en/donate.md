...
**Initial setup costs** include around 3,500 EUR for setting up all the legal bits, privacy policy, terms and conditions appropriately.

**Recurring annual costs** mainly consist of:
- 100 EUR Website and domain hosting
- 299 EUR Apple corporate developer account
- 300 EUR Address search, and geocoding API (currently by MapTiler)
- 200 EUR Protomaps map tile hosting storage bucket and CDN
...
With all that considered, we currently estimate that **sustainable maintenance of Reunicorn costs ~16,900 EUR annually**.
