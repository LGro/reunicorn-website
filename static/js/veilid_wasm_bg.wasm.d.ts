...
export function change_log_ignore(a: number, b: number, c: number, d: number): void;
...
export function routing_context_set_dht_value(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): number;
...
export function routing_context_inspect_dht_record(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
...
export function crypto_generate_shared_secret(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
...
export function default_veilid_config(a: number): void;
...
export function veilidclient_changeLogIgnore(a: number, b: number, c: number, d: number): void;
...
export function veilidclient_now(a: number): void;
...
export function veilidclient_defaultConfig(a: number): void;
...
export function veilidcrypto_generateSharedSecret(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
...
export function veilidroutingcontext_setDhtValue(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): number;
export function veilidroutingcontext_watchDhtValues(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): number;
export function veilidroutingcontext_cancelDhtWatch(a: number, b: number, c: number, d: number): number;
export function veilidroutingcontext_inspectDhtRecord(a: number, b: number, c: number, d: number, e: number): number;
...
export function wasm_bindgen__convert__closures__invoke1_mut__hdb5b5ad0b05faa23(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h444e61a53337f3a3(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfc472dba2441f5ed(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he6689a8fdbc87162(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__hc8c071e01b64bda9(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h0bf2a167f13f4c03(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h01ac960159519cee(a: number, b: number, c: number, d: number): void;
